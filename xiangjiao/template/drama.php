    ...
    <div class="navbar-container">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="drama.php" class="active">电视剧</a></li>
...
<div class="container clearfix">
    ...
    <div class="slider">
        <ul class="carousel" id="carousel">
            <?php if( $carousel_list && is_array( $carousel_list )) { ?>
                <?php foreach( $carousel_list as $k => $v ) {?>
            <li style="background-image: url(<?php echo explode(",",$v['main_pic'])[0];?>);">
                <div class="inner">
                    <h1><?php echo $v['drama_name'];?></h1>
                    <a class="btn" target="_blank" href="<?php echo $drama_detail_url."?drama_id=".$v["id"];?>">去百度云在线看</a>
                </div>
            </li>
            <?php }}?>
        </ul>
    ...
    <div class="search-info clearfix" id="search-info">
        <dl>
            <dt>区域</dt>
<!--            <dd><a href="drama.php">不限</a></dd>-->
            <?php if( $zone_list && is_array( $zone_list )) {?>
            <?php foreach( $zone_list as $k => $v ) {?>
            <dd class="zone <?php echo $v == $zone ? 'selected' : '';?>"><a href="<?php echo "drama.php?"."zone=".$v;?>"><?php echo $v;?></a></dd>
            <?php }}?>
        </dl>
        <dl>
            <dt>年代</dt>
            <?php if( $year_list && is_array( $year_list )) {?>
            <?php foreach( $year_list as $k => $v ) {?>
                <dd class="show_time <?php echo $v == $year ? 'selected' : '';?>"><a href="<?php echo "drama.php?"."year=".$v;?>"><?php echo $v;?></a></dd>
            <?php }}?>
        </dl>
        <dl>
            <dt>类型</dt>
<!--            <dd><a href="drama.php">不限</a></dd>-->
            ...
            <?php foreach( $drama_types as $k => $v ) {?>
                <dd class="drama_type <?php echo $v == $drama_type ? 'selected' : '';?>"><a href="<?php echo "drama.php?"."drama_type=".$v;?>"><?php echo $v;?></a></dd>
            <?php }}?>
        </dl>
    </div>
    ...
    <div class="main-content" id="main">
        <ul class="index-list clearfix">
            ...
            <li class="clearfix">
                <a href="<?php echo $drama_detail_url."?drama_id=".$v["id"];?>" target="_blank" title="<?php echo $v['drama_name'];?>" class="index-img">
                    <img src="<?php echo explode(",",$v['main_pic'])[0];?>" alt="<?php echo $v['drama_name'];?>">
                    <div class="bottom-cover">
                        <span class="film-time"></span>
                    </div>
                </a>
                <div class="index-text">
                    <h1><a  href="<?php echo $drama_detail_url."?drama_id=".$v["id"];?>" target="_blank" title="<?php echo $v['drama_name'];?>"><?php echo $v['drama_name'];?> </a></h1>
                    <div class="index-con">
                        <div class="rating" data-score=""></div>
                    </div>
                    <div class="index-intro"><?php echo $v['brief_desc'];?>
                    </div>
                    <div class="index-more"><a href="javascript:;" title="<?php echo $v['drama_name'];?>"
                    >阅读全文...</a></div>
                    <div class="index-like clearfix"><span class="time"><?php echo $v['show_time'];?></span>
                        <div class="post-ope"><span class="post-comment">306</span> <span class="post-like">0</span>
                        </div>
                    </div>
                </div>
            </li>
        ...
        <div class="post-right-item">
            ...
            <?php if($drama_rank && is_array($drama_rank)) {?>
                <?php foreach($drama_rank as $k => $v ) {?>
                    <li><a href="<?php echo $drama_detail_url."?drama_id=".$v["id"];?>" target="_blank" title="<?php echo $v['drama_name'];?>" title="<?php echo $v['drama_name'];?>"><span class="hot-num"><?php echo $k + 1;?></span><?php echo $v['drama_name'];?></a></li>
                <?php }}?>
            </ul>
        </div>
        <div class="post-right-item">
