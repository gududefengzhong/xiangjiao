...
<head>
    ...
    <script>
        ...
        (function() {
            ...
            hm.src = "//hm.baidu.com/hm.js?e5cdd66cdf98f01b40fb7aacb7b18e81";
...
<div class="container clearfix">
    ...
    <div class="recommend" id="recommend">
        <div class="big-images">
            <a href="<?php echo $detail_url."?id=".$recommend_list[0]['id'];?>" target="_blank" style="background-image: url(<?php echo explode(",", $recommend_list[0]['main_pic'])[0];?>);">
                <span class="tags">视频资源</span>
                <span class="desc"><?php echo $recommend_list[0]['movie_title'];?></span>
            </a>
        </div>
        <div class="small-images">
            <?php array_shift($recommend_list); ?>
            <?php foreach( $recommend_list as $k => $v ) {?>
                <div class="block <?php echo $k == 0 ? "wider" : "";?>">
                    <a href="<?php echo $detail_url."?id=".$v['id'];?>" target="_blank" style="background-image: url(<?php echo explode(",", $v['main_pic'])[0];?>);">
                        <span class="tags">视频资源</span>
                        <span class="desc"><?php echo $v["movie_title"];?></span>
                    </a>
                </div>
            <?php }?>
    ...
    <div class="side" id="right-side">
        <div class="post-right-item">
            ...
            <div class="tags">
                ...
                <a href="movie.php?movie_type=<?php echo $v;?>"><?php echo $v;?></a>
                <?}}?>
            </div>
        </div>
        <div class="post-right-item">
