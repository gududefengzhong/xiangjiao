...
<div class="container main">
    <div class="row">
        ...
        <form id="edit_movie" class="form-horizontal edit-form" method="POST" action="/app/crm/app/edit_movie.php"
              enctype="multipart/form-data" role="form">
            <input type="hidden" name="id" type="text" value="<?php echo $id;?>">
            <div class="form-group">
                <label class="col-sm-2 control-label">电影名称</label>
                <div class="col-sm-10">
                    <input type="text" value="<?php echo $edit_info['movie_name'];?>" class="form-control drama_name" name="movie_name">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">上映时间</label>
                <div class="col-sm-10">
                    <input value="<?php echo $edit_info['show_time'];?>" type="text" class="form-control show_time" name="show_time"
