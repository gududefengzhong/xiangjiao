...
<div class="container main">
    <div class="row">
        ...
        <div class="col-sm-10 content">
            <div><a class="btn btn-info add" id="add_drama" target="_blank" href="add_drama.php">新建</a></div>
            <!--        查询条件-->
            <form action="drama.php" method="get" class="form-inline search-form" role="form">
                <div class="form-group">
                    ...
                    <label>类型</label>
                    <input type="text" name="drama_type" value="<?php echo $drama_type;?>" placeholder="请输入电影类型">
            ...
            <table class="table table-hover table-striped">
                ...
                <?php if( $drama_info && is_array( $drama_info ) ) {?>
                    <?php foreach ($drama_info as $k => $v) { ?>
                        <tr>
                            <td>
                                <a href="../app/edit_drama.php?id=<?php echo $v["id"];?>" title="编辑" data_id="<?php echo $v['id']; ?>"
                            ...
                            <td><?php echo $v["drama_type"]; ?></td>
                            <td><?php echo $v["create_time"]; ?></td>
                            <td>
                                <a href="../app/drama_info.php?drama_id=<?php echo $v["id"];?>" title="添加电视剧" data_id="<?php echo $v['id']; ?>"
                                   class="btn btn-info add_drama_info">添加电视剧</a>
                            </td>
        ...
        $(".del").each(function () {
            ...
            $(this).on("click", function () {
                $.ajax({
                    type: "POST",
                    dataType: "JSON",
                    url: "/app/crm/app/drama_ajax.php?action=delete",
                    data: "row_id=" + row_id,
